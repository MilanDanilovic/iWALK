...
class Walks {
    ...
    private var postWalkerUsername: String? = null
    ...
    fun getPostWalkerUsername(): String? {
        return postWalkerUsername
    }

    fun setPostWalkerUsername(postWalkerUsername: String?) {
        this.postWalkerUsername = postWalkerUsername
    }
}